...
/* ===
Script adapted from: ml5 Example / PoseNet example using p5.js
Available from https://ml5js.org/
=== */
...
function setup() {
	...
	button = createButton('Switch Sides');
...
function modelReady() {
	select('#status').style('background-color', '#3da9fc');
	select('#status').html('Ready! <i class="fas fa-check-circle" style="color:white;"></i>');
}
